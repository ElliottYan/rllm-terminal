...
export TRAIN_DATASET_PATH=$LOCAL_DIR/rllm-terminalrllm/data/datasets/deepscaler_math/train.parquet
export TEST_DATASET_PATH=$LOCAL_DIR/rllm-terminalrllm/data/datasets/aime2024/test.parquet
